...
public class RegistrarOrdenPagoCPySFPage2 extends FacturarOnLineBasePage {
	...
	public RegistrarOrdenPagoCPySFPage2() {
		setearDefaultModel();
	...
	private void crearForm() {
		...
		Form<?> form = new Form<Void>("form") {
			...
			protected void onValidate() {
				...
				OrdenPago ordenPago = (OrdenPago)RegistrarOrdenPagoCPySFPage2.this.getDefaultModelObject();
			...
			protected void onSubmit() {
				...
				setResponsePage(RegistrarOrdenPagoCPySFPage3.class, new PageParameters());
			}
			 ...
			 * Ademas Agrego los Pagos de Efectivo y Transf a 3ros
			 * @param ordenPago
			 */
		...
		seccionCheques.add(new AjaxFallbackLink<Pago>("agregarCheque") {
			...
			public void onClick(AjaxRequestTarget target) {
				...
				pago.setModoPago(ModoPago.CHEQUE);
				pago.setOrdenPago(ordenPago);
				((OrdenPago)RegistrarOrdenPagoCPySFPage2.this.getDefaultModelObject()).getListadoPagos().add(pago);
	...
	private IDataProvider<Pago> getChequesProvider() {
		IDataProvider<Pago> PagosDataProvider = new IDataProvider<Pago>() {
			...
			private List<Pago> getListadoTodosPagos() {
				List<Pago> listaPagos = ((OrdenPago)RegistrarOrdenPagoCPySFPage2.this.getDefaultModelObject()).getListadoPagos();
